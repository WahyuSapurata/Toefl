    ...
    <div class="hover-scroll-overlay-y mb-5 mb-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu menu-column mt-2 menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            @if ($role === 'admin')
                <!--begin::Menu item-->
                <div class="menu-item">
                    <a class="menu-link {{ isset($path[1]) && $path[1] === 'datauser' ? 'active' : '' }}"
                        href="{{ route('admin.datauser') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <img src="{{ isset($path[1]) && $path[1] === 'datauser' ? url('admin/assets/media/icons/aside/adminact.svg') : url('admin/assets/media/icons/aside/admindef.svg') }}"
                                    alt="">
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                        <span class="menu-title"
                            style="{{ isset($path[1]) && $path[1] === 'datauser' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Data
                            User</span>
                    </a>
                </div>
                <!--end::Menu item-->
                ...
                <!--begin::Menu item-->
                <div class="menu-item">
                    <a class="menu-link {{ isset($path[1]) && $path[1] === 'kategori' ? 'active' : '' }}"
                        href="{{ route('admin.kategori') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <img src="{{ isset($path[1]) && $path[1] === 'kategori' ? url('admin/assets/media/icons/aside/kategoriact.svg') : url('admin/assets/media/icons/aside/kategoridef.svg') }}"
                                    alt="">
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                        <span class="menu-title"
                            style="{{ isset($path[1]) && $path[1] === 'kategori' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Kategori
                            Soal</span>
                    </a>
                </div>
                <!--end::Menu item-->
                ...
                <!--begin::Menu item-->
                <div class="menu-item">
                    <a class="menu-link {{ isset($path[1]) && $path[1] === 'soal' ? 'active' : '' }}"
                        href="{{ route('admin.soal') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <img src="{{ isset($path[1]) && $path[1] === 'soal' ? url('admin/assets/media/icons/aside/rekapact.svg') : url('admin/assets/media/icons/aside/rekapdef.svg') }}"
                                    alt="">
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                        <span class="menu-title"
                            style="{{ isset($path[1]) && $path[1] === 'soal' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">
                            Soal</span>
                    </a>
                </div>
                <!--end::Menu item-->
                ...
                <div class="menu-item">
                    <a class="menu-link {{ isset($path[1]) && $path[1] === 'nilai' ? 'active' : '' }}"
                        ...
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <img src="{{ isset($path[1]) && $path[1] === 'nilai' ? url('admin/assets/media/icons/aside/gajiact.svg') : url('admin/assets/media/icons/aside/gajidef.svg') }}"
                                    alt="">
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                        <span class="menu-title"
                            style="{{ isset($path[1]) && $path[1] === 'nilai' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">
                            Nilai</span>
                    </a>
                </div>
                <!--end::Menu item-->
