...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            control.submitData('/admin/update-datauser/' + $(this).attr('data-uuid'), 'Kirim',
                'Data', 'POST');
        })
                ...
                columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        result =
                            `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/bukti/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/bukti/${data}')">
                                    </div>
                                    <!--end::Image-->
                        ...
                        if (status) {
                            ...
                            return `
                                        <div class="d-flex justify-content-center">
                                            ...
                                            style="max-width: max-content">
                                            <div class="fw-bolder text-capitalize">Belum terverifikasi</div>
                                        </div>
                                        </div>
                                    `;
                        }
